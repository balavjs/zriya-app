...
if(isset($_POST['submit'])){
  ...
  $data .= "
              ...
              <div class='row pdf_row'>
                <div class='col-md-6'>
                  <div style='padding:0px;'>
                    <img src='https://zriyasolutions.com/employee_portal/zriya_app/dist/img/logo.png' width='200'> 
                  </div>
                </div> 
                <div class='col-md-6'>
              ...
              <div class='row'>
                <div class='col-md-12'>
                  <table class='sal_table1' width='100%' style='border-collapse: collapse;'>                    
                    <tr>
                      <th align='left' width='150px'>Issued date</th>
                      <td>: ".$sal_date1."</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <th align='left' width='200px'>Employee ID</th>
                      <td>: ".$emp_id1."</td>
                    </tr>
                    <tr>
    ...
    $data .= "
                    <tr>
                      <th align='left' width='200px'>Month & Year</th>
              ...
              <div class='row'>
                <div class='col-md-12'>
                  <h3 style='font-size:16px;'>Salary notice</h3>
                </div>
                ...
                <table class='sal_table1' width='100%' style='border:1px solid #b0b0b0;margin: 0 10px; border-collapse: collapse;'>
                  <tr>
                    ...
                    <th style='border-bottom:1px solid #b0b0b0; padding:10px;text-align:left'>Salary Type</th>
                    <th style='border-bottom:1px solid #b0b0b0; padding:10px;text-align:left'>Description</th>
                    <th style='border-bottom:1px solid #b0b0b0; padding:10px;text-align:center'>Qty</th>
                    <th style='border-bottom:1px solid #b0b0b0; padding:10px;text-align:center'>Price</th>
                    <th style='border-bottom:1px solid #b0b0b0; padding:10px;text-align:center'>Total</th>
                  </tr>
          ";                                  
                ...
                <table width='100%' style='margin: 0 10px; border-collapse: collapse;'>  
                  <tr>
                    <td style='border:1px solid #b0b0b0;border-top:0;' colspan='2'>
                      <table width='100%' style='margin: 0 10px; border-collapse: collapse;'>
                        <tr>
                          <th class='text-center' style='border-bottom:1px solid #b0b0b0; padding:10px;'>Vacation days</th>
                        </tr>
                        <tr>
                          <td style='padding-top:10px'>Vacation</td>
                          <td></td>
                        </tr>
                        <tr>
                          <td>Paid / Unpaid</td>
                        ...
                        <tr>
                          <td style='padding-bottom:10px'>Taken out</td>
                    ...
                    <td style='border:1px solid #b0b0b0;border-top:0;border-left:0; ' colspan='2'>
                      <table width='100%' style='margin: 0 10px; border-collapse: collapse;'>
                        <tr>
                          <th colspan='3' class='text-center' style='border-bottom:1px solid #b0b0b0; padding:10px;'>Amount</th>
                        </tr>
                        <tr>
                          <td style='padding-top:10px;'></td>
                          <td style='text-align:right;padding-top:10px;'><b>Total during the year</b></td>
                          <td style='text-align:right;padding-top:10px;'><b>Total during the period</b></td>
                        </tr>
                        <tr>
                          <td>Gross Salary</td>
                        ...
                        <tr style='padding-bottom:10px'>
                          <td>Tax</td>
                          <td style='text-align:right;padding-bottom:10px;'>".$vat."</td>
                          <td style='text-align:right;padding-bottom:10px;'>".$vat."</td>
                        </tr>
                      </table>
                    </td>
                    <td style='border:1px solid #b0b0b0; border-top:0;border-left:0;' colspan='2'>
                      <table width='100%' style='margin: 0 10px; border-collapse: collapse;'>
                        <tr>
                          <th colspan='2' class='text-center' style='border-bottom:1px solid #b0b0b0; padding:10px;'>This Period</th>
                        </tr>
                        <tr>
                          <td style='padding-top:10px;'>Gross Salary (".$currency.")</td>
                        ...
                        <tr>
                          <td>Tax Invoice (".$currency.")</td>
                          <td style='text-align:right'>".$vat."</td>
                        </tr>
                        <tr>
                          <td style='padding-bottom:10px;'><b>Paid Out (".$currency.")</b></td>
