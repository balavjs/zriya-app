<?php
  $title = "Finance Clothing - India Update | Zriya Solutions";
  ob_start();
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Finance Clothing - India</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active"><a href="finance_cl_in_view.php">Finance Clothing - India</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">             
            ...
            <div class="card">
              <div class="card-header card-zg">
                <h3 class="card-title">Finance Clothing - India Details</h3>
              </div>        
              ...
              <?php
                ...
                if(isset($_POST['update'])){
                  ...
                  $sql = $result->update($id, $id1, $signed, $comp_id, $p_status, $p_date, $p_comment, $product_desc, $u_price, $qty, $price, $currency, $vat, $vatval, $total, $pricetotal, $momtotal, $subtotal, $advance, $gtotal, $comment, $status);
              ...
              ?>
                ...
                <form method="post">
                  <?php
                    $id = $_GET['id'];
                    $result1 = new DB_finance_cl_in();
                    $sql1 = $result1->get_one_finance_cl_in($id);   
                  ...
                  <div class="row">
                    <table class="table" id="orders">    
                      ...
                      <?php
                        $result=new DB_finance_cl_in();
                        $id = $_GET['id'];
                        $sqlf = $result->list_finance_cl_in_desc($id);
                        $i=0;
                        ...
                        foreach ($sqlf as $list) {  
                          ...
                          $id1 = $list['id'];
                          $finance_cl_in_id = $list['finance_cl_in_id'];       
                      ...
                      ?>
                      <tr id="tr_rows">
                        <input type="hidden" class="form-control" name="finance_cl_in_id[]" value="<?php echo $finance_cl_in_id; ?>">  
                        ...
                        <td><a href="finance_cl_in_det_delete.php?id=<?php echo $id1;?>&row_id=<?php echo $id;?>" onClick="return confirm('Do you really want to delete?');"><button type="button" name="remove" id="<?php echo $i; ?>" class="btn btn-danger btn_remove cicle">-</button></a></td>                 
                      </tr>
                      <?php
                    }
                  }
...
$("#orders").on('input', '.vat,input.price,input.u_price,input.qty', function() {
