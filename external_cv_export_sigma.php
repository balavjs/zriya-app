...
$vWordFileName="Sigma-CV-".$name.".doc"; //replace your file name from here.
          ...
          <div style='mso-element:header' id="h1" >
            <p class="MsoHeader">
              <table border="0" width="100%">
                <tr>                  
                  <td align="right">
                    <img src="https://zriyasolutions.com/employee_portal/zriya_app/dist/img/sigma.png">
                  </td>
                </tr>
              </table>
            </p>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="center" class="footer">
                    <p>
                    Sigma är ett ledande konsultföretag som arbetar för att öka sina kunders konkurrenskraft. För att nå dit kombinerar vi vårt tekniska know-how med ett brinnande intresse för att ständigt utveckla bättre lösningar. Sigma ägs av Danir AB, som är familjen Dan Olofssons holdingbolag.</p>
