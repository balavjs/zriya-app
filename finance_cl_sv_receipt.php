...
if(isset($_POST['submit'])){
  ...
  if($p_status !=0){
    $mpdf->SetWatermarkImage('https://zriyasolutions.com/employee_portal/zriya_app/dist/img/paid_img.png');
                  ...
                  <p>
                    ...
                    <table width='100%' style='border:1px solid #b0b0b0;margin: 0 10px; border-collapse: collapse;'>
                      <tr>
                        ...
                        <th align='center' style='border:1px solid #b0b0b0; padding:10px; width:100px;'>Price (excl. MOMS SEK)</th>
                        <th align='center' style='border:1px solid #b0b0b0; padding:10px; width:100px;'>MOMS (SEK)</th>
