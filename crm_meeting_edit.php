<?php
  $title = "CRM Meetings Update | Zriya Solutions";
  ob_start();
?>
          ...
          <div class="col-12">             
            ...
            <div class="card">
              <div class="card-header card-zg">
                <h3 class="card-title">Update Meeting Details</h3>
              </div>          
              ...
              <?php
                ...
                if(isset($_POST['update'])){
                  ...
                  {
                    $check_mail   = $_POST['check_mail']; 
                    //echo $check_mail;  //  Displaying Selected Value
                  }
                  else{
                    $check_mail= "0";
                  }
                              
                  $sql = $result->update($id, $host, $host_email, $from_date, $to_date, $participants, $check_mail, $subject, $description, $status);
                ...
                <form method="post">
                  <?php
                    ...
                    $sql1 = $result1->get_one_crm_meeting($id);   

                    while($row = mysqli_fetch_array($sql1)){    
                      $from_date = date("Y-m-d\TH:i:s", strtotime($row['from_date']));
                      $to_date = date("Y-m-d\TH:i:s", strtotime($row['to_date']));
                  ?>
                  ...
                  <div class="row">                    
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>Host</label>
                        <input type="text" class="form-control" placeholder="Enter the host name" name="host" value="<?php echo $row['host']; ?>" required>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <p><b>Created with: </b><?php echo $row['host_email']; ?> </p>                      
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">           
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="datetime-local" class="form-control" name="from_date" value="<?php echo $from_date; ?>" required>
                      </div>
                    </div>                    
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>To Date</label>
                        <input type="datetime-local" class="form-control" name="to_date" value="<?php echo $to_date; ?>" required>
                      </div>
                    </div>                    
                  </div>                    
                  ...
                  <div class="row"> 
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <select class="form-control" name="participants[]" id="insightList" multiple="multiple" required>
                          ...
                          <p><b>Created with: </b><?php echo $row['participants']; ?> </p>  
                      </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>Subject</label>
                        <input type="text" class="form-control" placeholder="Enter the subject" name="subject" value="<?php echo $row['subject']; ?>"required>             
                      </div>
                    </div>
                  </div>
                  
                  <div class="form-check1">
                    <input type="checkbox" name="check_mail" value="1" <?php if($row['check_mail']=='1'){echo "checked='checked'";} ?>>
