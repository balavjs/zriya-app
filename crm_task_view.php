<?php
  $title = "CRM Tasks | Zriya Solutions";
?>
        ...
        <div class="row">
          <div class="col-12">             
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <a href="crm_task_add.php">
                  <button class="btn btn-zo">Add New Task</button>
                </a><br><br>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>                      
                        ...
                        <a href="crm_task_edit.php?id=<?php echo $list['id'];?>"><button class="btn btn-zo" data-toggle="tooltip" data-placement="top" title="Update"><i class="nav-icon fas fa-edit"></i></button></a> 
                        <a href="crm_task_delete.php?id=<?php echo $list['id'];?>" class="btn-del"><button class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Delete"><i class="nav-icon far fa-trash-alt"></i></button></a>
                      </td>                    
                    </tr>
                    <?php
                    }
...
<script>  
  ...
  $(function () {
...

    {
        ...
        title: 'Zriya Solutions - CRM Task',
        exportOptions: {
