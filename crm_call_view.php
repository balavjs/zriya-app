<?php
  $title = "CRM Calls | Zriya Solutions";
?>
        ...
        <div class="row">
          <div class="col-12">             
            ...
            <div class="card">
              ...
              <div class="card-body">
                <a href="crm_call_add.php">
                  <button class="btn btn-zo">Add New Call</button>
                </a><br><br>
                <table id="example1" class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php $date = strtotime($list['call_time']); echo date('h:i a', $date); ?></td>                    
                      ...
                      <td>                      
                        ...
                        <a href="crm_call_edit.php?id=<?php echo $list['id'];?>"><button class="btn btn-zo" data-toggle="tooltip" data-placement="top" title="Update"><i class="nav-icon fas fa-edit"></i></button></a> 
                        <a href="crm_call_delete.php?id=<?php echo $list['id'];?>" class="btn-del"><button class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Delete"><i class="nav-icon far fa-trash-alt"></i></button></a>
                      </td>                    
                    </tr>
                    <?php
                    }
...
<script>  
  ...
  $(function () {
...

    {
        ...
        title: 'Zriya Solutions - CRM Calls',
        exportOptions: {
