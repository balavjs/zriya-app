...
$vWordFileName="Combitech-CV-".$name.".doc"; //replace your file name from here.
          ...
          <div style='mso-element:header' id="h1" >
            <p class="MsoHeader">
              <table border="0" width="100%">
                <tr>                  
                  <td align="right">
                    <img src="https://zriyasolutions.com/employee_portal/zriya_app/dist/img/combitech.png">
                  </td>
                </tr>
              </table>
            </p>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="center" class="footer">
                    <p>
                    This document and the information contained herein is the property of Combitech AB and must not be<br> used, disclosed or altered without  Combitech AB prior written consent.<br>
                    KONFIDENTIELL</p>
