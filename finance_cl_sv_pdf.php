                  ...
                  <p>
                    ...
                    <table width='100%' style='border:1px solid #b0b0b0;margin: 0 10px; border-collapse: collapse;'>
                      <tr>
                        ...
                        <th align='center' style='border:1px solid #b0b0b0; padding:10px;'>Unit Price (SEK)</th>
                        <th align='center' style='border:1px solid #b0b0b0; padding:10px;'>Qty</th>
                        <th align='center' style='border:1px solid #b0b0b0; padding:10px; width:120px;'>Price (excl. MOMS SEK)</th>
                  ...
                  <p>
                    <table width='100%' style='border:1px solid #b0b0b0;margin: 0 10px; border-collapse: collapse;'>
                      <tbody>
                        ...
                        <tr>
                          <th style='border:1px solid #b0b0b0; padding:10px; text-align: left;'>Invoice Date</th>
