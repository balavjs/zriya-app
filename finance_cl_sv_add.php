<?php
  $title = "Finance Clothing - Sweden Add | Zriya Solutions";
  ob_start();
?>
              ...
              <div class="card-body">  
                ...
                <?php
                    ...
                    if(isset($_POST['submit'])){
                      ...
                      $sql = $result->insert($invoice_no, $receipt_no, $inv_cnt, $year, $signed, $inv_date, $terms, $due_date, $comp_id, $product_desc, $u_price, $qty, $price, $vat, $total, $pricetotal, $momtotal, $subtotal, $advance, $gtotal, $comment, $status);
                      if ($sql) {                          
                ...
                <form method="post" name="myform" onsubmit="enableSample();">
                  ...
                  <div class="row">
                    <?php 
                      ...
                      $result = new DB_finance_cl_sv();
                      $sql = $result->list_finance_cl_sv_last1();  
                      ...
                      foreach ($sql as $list) { 
                        ...
                        $sql3 = $result->list_finance_cl_sv_year($y1);
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter the Invoice No" name="invoice_no" value="INV-CL-SV-<?php echo $y1."-000".$next_id; ?>" readonly required>
                        <input type="hidden" class="form-control" placeholder="Enter the Receipt no" name="receipt_no" value="REC-CL-SV-<?php echo $y1."-000".$next_id; ?>" readonly required>
                  ...
                  <div class="row"> 
                    <table class="table" id="orders">
                      ...
                      <tr>
                        ...
                        <td><input class="form-control u_price" type='number' data-type="u_price" id='u_price_1' name='u_price[]' for="1"/ min="0" step="any" required></td>
                        <td><input class="form-control qty" type='number' data-type="qty" id='qty_1' name='qty[]' for="1"/ min="0" step="any" required></td>
