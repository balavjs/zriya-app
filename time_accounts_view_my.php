                ...
                <table id="example1" class="table">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="time_accounts_detail.php?id=<?php echo $before.$list['id'].$after;?>" target="_blank"><button class="btn btn-zg" data-toggle="tooltip" data-placement="top" title="View"><i class="nav-icon fas fa-eye"></i></button></a> 
                      <a href="time_accounts_edit.php?id=<?php echo $before.$list['id'].$after;?>"><button class="btn btn-zo" data-toggle="tooltip" data-placement="top" title="Update"><i class="nav-icon fas fa-edit"></i></button></a> 
