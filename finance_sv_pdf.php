...
if(isset($_POST['submit'])){
  ...
  foreach ($sql as $list) { 
    ...
    $ddate      = date('Y-m-d', strtotime($date. ' + '.$terms.' days'));
    $signed     = $list['signed'];    
    $due_date   = $list['due_date']; 
    $due_date1  = date('Y-m-d', strtotime($due_date));  
    $p_status   = $list['p_status'];
              ...
              <div class='row pdf_row'>
                <div class='col-md-6' style='border-right:1px solid #b0b0b0; margin-left:-1px; text-align:center;' >
                  <div style='padding:10px;'>
                    ...
                    <span>
                      Organisation No: 559361-1030<br>
                  ...
                  <p>
                    ...
                    <table width='100%' style='border:1px solid #b0b0b0;margin: 0 10px; border-collapse: collapse;'>
                      <tr>
                        ...
                        <th align='center' style='border:1px solid #b0b0b0; padding:10px;'>Hour Rate</th>
                        <th align='center' style='border:1px solid #b0b0b0; padding:10px;'>No.of Hours</th>
                        <th align='center' style='border:1px solid #b0b0b0; padding:10px; width:120px;'>Price</th>
                        <th align='center' style='border:1px solid #b0b0b0; padding:10px; width:120px;'>MOMS (SEK)</th>
                        <th align='center' style='border:1px solid #b0b0b0; padding:10px; width:120px;'>Total (SEK)</th>
                      </tr>
                      <tbody>
                      ";    
                      ...
                      $hrs_rate     = $list1['hrs_rate'];
                      $hrs_nos      = $list1['hrs_nos'];
                      $price        = $list1['price'];
  ...
  $data .= "
                          ...
                          <td style='border:1px solid #b0b0b0; padding:10px; text-align:center;'>".$hrs_rate."</td>
            "; 
                      }
                      else{
   $data .= "
                        
                          <td style='border:1px solid #b0b0b0; padding:10px; text-align:center;'>-</td>
            ";
  ...
  $data .= "
                          ...
                          <td style='border:1px solid #b0b0b0; padding:10px; text-align:center;'>".$hrs_nos."</td>
            "; 
                      }
                      else{
   $data .= "
  ...
  $data .= " 
                          ...
                          <td style='border:1px solid #b0b0b0; padding:10px; text-align:right;'>".number_format($vat, 2, ',', ' ')."</td>
  ...
  $data .= "                      
                        <tr>
                          <th colspan='4' style='border:1px solid #b0b0b0; padding:10px; text-align:right;'>Subtotal (SEK)</th>
  ...
  $data .= "                      
                        <tr>
                          <th colspan='6' style='border:1px solid #b0b0b0; padding:10px; text-align:right;'>Advance (SEK)</th>
                          <td style='border:1px solid #b0b0b0; padding:10px; text-align:right;'>".number_format($advance, 2, ',', ' ')."</td>
                        </tr>
            ";
  ...
  $data .= "                      
                        <tr>
                          <th colspan='6' style='border:1px solid #b0b0b0; padding:10px; text-align:right;'>Grand Total (SEK)</th>
  ...
  $data .= "
                        ...
                        <tr>
                          <th colspan='7' style='border:1px solid #b0b0b0; padding:10px; text-align:left;'>Comments</th>
                        </tr>
                        <tr>
                          <td colspan='7' style='border:1px solid #b0b0b0; padding:10px;'>".$comment."</th>                                
                        </tr>
            ";
                        }
  $data .= "                     
                  ...
                  <p>
                    <table width='100%' style='border:1px solid #b0b0b0;margin: 0 10px; border-collapse: collapse;'>
                      <tbody>
                        <tr>
                          <th colspan='2' style='text-align: left; padding:10px;'><b>Payment Terms</b></th>
                        </tr>
                        <tr>
                          <th style='border:1px solid #b0b0b0; padding:10px; text-align: left; width:40%;'>Invoice Date</th>
                          <td style='border:1px solid #b0b0b0; padding:10px;'>".$date1."</td>
                        </tr>
                        <tr>  
                          <th style='border:1px solid #b0b0b0; padding:10px; text-align: left;'>Payment Terms</th>
                          <td style='border:1px solid #b0b0b0; padding:10px;'>
                          ";
                ...
                $data .= "          
                        ...
                        <tr>  
                          <th style='border:1px solid #b0b0b0; padding:10px; text-align: left;'>Due Date</th>
                          <td style='border:1px solid #b0b0b0; padding:10px;'>
                          ";
                  ...
                  <p>
                    <table width='100%' style='border:1px solid #b0b0b0;margin: 0 10px; border-collapse: collapse;'>
                      <tbody>
                        ...
                        <tr>
                          <th style='border:1px solid #b0b0b0; padding:10px; text-align: left; width:40%;'>Bankgiro Number </th>
                          <td style='border:1px solid #b0b0b0; padding:10px;'>5917-8293</td>
                        </tr>
                        <tr>  
                          <th style='border:1px solid #b0b0b0; padding:10px; text-align: left;'>Account No</th>
                          <td style='border:1px solid #b0b0b0; padding:10px;'>5380 10 922 67</td>   
                        </tr>
                        <tr>  
                          <th style='border:1px solid #b0b0b0; padding:10px; text-align: left;'>Bank Name </th>
                          <td style='border:1px solid #b0b0b0; padding:10px;'>SEB</td>   
                        </tr>
                        <tr>  
                          <th style='border:1px solid #b0b0b0; padding:10px; text-align: left;'>IBAN</th>
                          <td style='border:1px solid #b0b0b0; padding:10px;'>SE2750000000053801092267</td>   
                        </tr>
                        <tr>  
                          <th style='border:1px solid #b0b0b0; padding:10px; text-align: left;'>BIC/SWIFT</th>
                          <td style='border:1px solid #b0b0b0; padding:10px;'>ESSESESS</td>   
                        </tr>
                      </tbody>
                    </table>
                  </p>
