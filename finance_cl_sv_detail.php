<?php
  $title = "Finance Clothing - Sweden Details | Zriya Solutions";
?>
          ...
          <div class="col-12">             
            ...
            <div class="card">
              <div class="card-header card-zg">
                <h3 class="card-title">Finance Clothing - Sweden</h3>
              </div>              

                  <div class="card-body">
                    <a href="finance_sv_view.php">
                      <button class="btn btn-zo"><i class="fas fa-chevron-left"></i> Back to Finance Clothing - Sweden</button>
                    </a><br><br>
                          ...
                          <p>
                            ...
                            <table id="example1" class="table table-bordered">
                              <thead>
                                ...
                                <th class="text-center" width="150px">Price (excl. MOMS SEK)</th>
                                <th class="text-center" width="160px">MOMS (SEK)</th>
                                <th class="text-center" width="150px">Total (SEK)</th>
                              </thead>
                              <tbody>
                                <?php
