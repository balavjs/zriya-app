<?php
  $title = "Finance Clothing - India Details | Zriya Solutions";
?>
          ...
          <div class="col-12">             
            ...
            <div class="card">
              <div class="card-header card-zg">
                <h3 class="card-title">Finance Clothing - India</h3>
              </div>             

              <div class="card-body">
                <a href="finance_cl_in_view.php">
                  <button class="btn btn-zo"><i class="fas fa-chevron-left"></i> Back to Finance Clothing - India</button>
                </a><br><br>
