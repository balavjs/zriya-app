<?php
  $title = "Finance Clothing - India Add | Zriya Solutions";
  ob_start();
?>
            ...
            <div class="card">
              ...
              <?php
                ...
                if(isset($_POST['submit'])){
                  ...
                  $sql = $result->insert($invoice_no, $receipt_no, $inv_cnt, $year, $signed, $comp_id, $product_desc, $u_price, $qty, $price, $currency, $vat, $vatval, $total, $pricetotal, $momtotal, $subtotal, $advance, $gtotal, $comment, $status);
                  if ($sql) {                          
              ...
              <form method="post" name="myform" onsubmit="enableSample();">
                <div class="row">                    
                  ...
                  <?php 
                    ...
                    $result = new DB_finance_cl_in();
                    $sql = $result->list_finance_cl_in_last1();  
                    ...
                    foreach ($sql as $list) { 
                      ...
                      $sql3 = $result->list_finance_cl_in_year($y1);
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Enter the Invoice No" name="invoice_no" value="INV-CL-IN-<?php echo $y1."-000".$next_id; ?>" readonly required>
                      <input type="hidden" class="form-control" placeholder="Enter the Receipt no" name="receipt_no" value="REC-CL-IN-<?php echo $y1."-000".$next_id; ?>" readonly required>
                ...
                <div class="row"> 
                  <table class="table" id="orders">
                    ...
                    <tr>
                      ...
                      <td><input class="form-control u_price" type='number' data-type="u_price" id='u_price_1' name='u_price[]' for="1"/ min="0" value="" step="any" required></td>
                      <td><input class="form-control qty" type='number' data-type="qty" id='qty_1' name='qty[]' for="1"/ min="0" value="" step="any" required></td>
                      <td><input class="form-control price" type='number' data-type="price" id='price_1' name='price[]' for="1"/ readonly></td> <!-- purchase_cost -->
                      <td>
