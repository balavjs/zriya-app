...
if(isset($_POST['submit'])){
  ...
  foreach ($sql as $list) { 
    ...
    $p_date     = $list['p_date'];
    $p_date1    = date('Y-m-d', strtotime($p_date));
    $p_comment  = $list['p_comment'];
  ...
  if($p_status !=0){
    $mpdf->SetWatermarkImage('http://localhost/zriya/zriya_app/dist/img/paid_img.png');
            ...
            <div class='container pdf_container'>
              <div class='row pdf_row'>
                ...
                <div class='col-md-6 column2'>
                  <div class='row'>
                    <div class='col-md-12' style='border-bottom:1px solid #b0b0b0; padding:20px 10px;'><b>Receipt No:</b> ".$receipt_no."</div>
  ...
  $data .= "
                  ...
                  <p>
                    Dear <b>".$name.",</b><br>
                    Thanks for your business. Kindly find this receipt and the payment is received with thanks.<br>
                  </p>
                  <p>
                    <b>Description</b>
                    <table width='100%' style='border:1px solid #b0b0b0;margin: 0 10px; border-collapse: collapse;'>
                      <tr>
                        ...
                        <th align='center' style='border:1px solid #b0b0b0; padding:10px;'>Description</th>
                  ...
                  <p>
                    <table width='100%' style='border:1px solid #b0b0b0;margin: 0 10px; border-collapse: collapse;'>
                      <tbody>
                        ...
                        <tr>  
                          <th style='border:1px solid #b0b0b0; padding:10px; text-align: left; width:50%;'>Amount paid </th>
                          <td style='border:1px solid #b0b0b0; padding:10px;'>".number_format($gtotal, 2, ',', ' ')." SEK</td>   
                        </tr>
                        <tr>
                          <th style='border:1px solid #b0b0b0; padding:10px; text-align: left;'>Bankgiro Number </th>
                          <td style='border:1px solid #b0b0b0; padding:10px;'>5917-8293</td>
                        </tr>                        
                        <tr>  
                          <th style='border:1px solid #b0b0b0; padding:10px; text-align: left;'>Final Date of Payment </th>
                          <td style='border:1px solid #b0b0b0; padding:10px;'>".$p_date1."</td>   
                        </tr>  
                        <tr>  
                          <th style='border:1px solid #b0b0b0; padding:10px; text-align: left;'>Comments </th>
                          <td style='border:1px solid #b0b0b0; padding:10px;'>".$p_comment."</td>   
                        </tr>                      
                      </tbody>
                    </table>
                  </p>
