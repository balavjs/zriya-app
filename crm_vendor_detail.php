<?php
  $title = "CRM Vendors Detail | Zriya Solutions";
?>
        ...
        <div class="row">
          <div class="col-12">             
            ...
            <div class="card">
              ...
              <div class="card-body">
                <a href="crm_vendor_view.php">
                  <button class="btn btn-zo"><i class="fas fa-chevron-left"></i> Back to Vendors</button>
                </a><br><br>
                <table id="example1" class="table">                  
                  <?php 
                    $id = $_GET['id'];
                    $result = new DB_crm_vendor();
                    $sql = $result->get_one_crm_vendor($id);   
                    $i=0;             
                    foreach ($sql as $list) { 
                      $i++;                                       
                  ?>                    
                  <tr>                    
                    <th>Vendor Owner</th>
                    <td><?php echo $list['vendor_owner'];?></td>
                  </tr>
                  <tr>                    
                    <th>Vendor Name</th>
                  ...
                  <tr>                    
                    <th>GL Account</th>
                    <td><?php echo $list['gl_account'];?></td>
                  </tr>
                  <tr>                    
                    <th>Category</th>
